...
add_links("vulkan-1", "shaderc_shared", "assimp-vc143-mt", "ktx.lib", "bcrypt.lib", "SDL2.lib")
...
target("Engine")
    ...
    after_build(function (target)
        os.cp(os.getenv("VK_SDK_PATH").."/Bin/SDL2.dll", path.join(target:targetdir(), "SDL2.dll"))
